from controllers import heartbeat, withdraw, storage_signin, storage_signup, get_availability, test_contract, \
    update_connection, storage_shard_done_uploading, test, active_contracts, get_storage_info
import app
...
def add_storage_urls():
    ...
    app.app.add_url_rule(storage_url_prefix + "/getStorageInfo", view_func=get_storage_info, methods=["GET"])
